   ...
   <body class="main-layout">
      ...
      <header>
         ...
         <div class="header">
            <div class="container">
               <div class="row">
                  <div class="order-2 col-xl-5 col-lg-5 col-md-9 col-sm-9">
                  ...
                  <div class="order-1 col-xl-2 col-lg-2 col-md-3 col-sm-3 col logo_section">
                     <div class="full">
                 ...
                 <div class="order-3 col-xl-5 col-lg-5 col-md-9 col-sm-9 d-flex justify-content-end">
                  <nav class="navigation navbar navbar-expand-md navbar-dark ">
                     <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarsExample04" aria-controls="navbarsExample04" aria-expanded="false" aria-label="Toggle navigation">
                     <span class="navbar-toggler-icon"></span>
                     </button>
